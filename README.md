...
| Total Deaths | 7 |
| Total Recoveries | 23 |
| Case Fatality Rate | **5.3%** |
| Recovery Rate | **17.4%** |
| Worst-Hit State | **Lagos (81 cases — 61% of national total)** |
| Peak Single Day | **20 new cases (March 30, 2020)** |
| States Affected | 27 |
...
![State Analysis](02_state_analysis.png)

### 3. Outcome Distribution & Fatality Rate by State
![Outcome Rates](03_outcome_rates.png)

### 4. Weekly Case Growth
![Weekly Spread](04_weekly_spread.png)

### 5. Daily Cases Heatmap — Top 10 States
![Heatmap](05_heatmap_top10.png)

### 6. Suspected vs Confirmed Cases by State
![Suspected vs Confirmed](06_suspected_vs_confirmed.png)
...
- GitHub: [github.com/akah-ebenezer](https://github.com/akah-ebenezer)
- LinkedIn: [linkedin.com/in/akah-ebenezer](https://linkedin.com/in/akah-ebenezer)
